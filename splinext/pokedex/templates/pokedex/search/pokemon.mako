...
<%def name="title()"><% _ = i18n.Translator(c) %>${_(u"Pokémon Search")}</%def>
...
<p>
    ...
    <button type="submit">${_(u"Search")}</button>
...
<%def name="td_icon(pokemon)"><td class="icon">${dexlib.pokemon_icon(pokemon)}</td></%def>
